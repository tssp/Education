...
The data is loaded into a *data.table* object via the *read.csv* function:
```{r, echo=TRUE}
...
# Plot histogram
qplot(steps, data=dtAggregate, binwidth = 300)+labs(title="Total number of steps", x="Number of Steps", y="Number of Days")
```
